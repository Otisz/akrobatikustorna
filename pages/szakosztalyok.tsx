...
const Page = () => (
  <>
    <Head>
      <title>Szakosztályok - Budai Akrobatikus Sport Egyesület</title>
            ...
            <tbody>
              <tr>
                <td rowSpan={2}>
                  ...
                  <Link
                    href="https://hu.frwiki.wiki/wiki/Gymnastique_acrobatique"
                    target="_blank"
                  >
                    Története
                  </Link>
                ...
                <td>
                  Versenynaptár (
                  <Link
                    href="/documents/Versenyszabalyzat_2022.pdf"
                    target="_blank"
                  >
                    szabályzat
                  </Link>
              ...
              <tr>
                <td>
                  ...
                  <ul className="list-disc list-inside text-left pl-8 mt-2">
                    <li>Rekreáció</li>
                    <li>
                      {'"'}B{'"'} kategória
                    </li>
                ...
                <td>
                  Versenynaptár (
                  <Link
                    href="/documents/1Viktoria-Kupa-versenyszabalyzat.pdf"
                    target="_blank"
                  >
                    szabályzat
                  </Link>
                  ...
                  <ul className="list-disc list-inside text-left pl-8 mt-2">
                    <li>
                      <Link
                        href="/documents/Akro-freestlye-kategoria-szabalyai-2022.pdf"
                        target="_blank"
                      >
                        Freestyle
                      </Link>
                    ...
                    <li>
                      <Link
                        href="/documents/Gula_torna_szabalyok.pdf"
                        target="_blank"
                      >
                        Gúlatorna
                      </Link>
                    ...
                    <li>
                      <Link
                        href="/documents/Kezallas_szabalyzat.pdf"
                        target="_blank"
                      >
                        Kézállófa
                      </Link>
              ...
              <tr>
                <td rowSpan={2}>
                  CheerLeading <br /> (
                  <Link
                    href="https://hu.wikipedia.org/wiki/Cheerleading#T%C3%B6rt%C3%A9nete"
                    target="_blank"
                  >
                    Története
                  </Link>
              ...
              <tr>
                ...
                <td>
                  Versenynaptár (
                  <Link
                    href="/documents/latvanytanc%20Versenyszabalyzat-2022.pdf"
                    target="_blank"
                  >
                    szabályzat
                  </Link>
              ...
              <tr>
                <td rowSpan={3}>
                  Szertorna <br /> (
                  <Link
                    href="https://hu.wikipedia.org/wiki/Torna_(sport)#T%C3%B6rt%C3%A9nete"
                    target="_blank"
                  >
                    Története
                  </Link>
