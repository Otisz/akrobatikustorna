    ...
    <Sheet>
      ...
      <SheetContent noClose className="bg-background w-full border-none p-0">
        <SheetHeader className="divide-background m-4 flex h-20 flex-row divide-x">
          ...
          <SheetClose
            className="bg-accent/30 hover:bg-accent border-border !m-0 inline-flex aspect-square h-full items-center justify-center rounded-xl border-2 transition-all hover:border-orange-500"
